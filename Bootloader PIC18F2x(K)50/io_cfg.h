...
#define OUTPUT_PIN          0
	...
	#define mInitAllSwitches()  TRISAbits.TRISA4 = 1; TRISAbits.TRISA5 = 1; TRISCbits.TRISC0 = 1;	\
								TRISCbits.TRISC7 = 1; TRISCbits.TRISC6 = 1;
    ...
    #define mInitAllJumpers()	TRISAbits.TRISA2 = 1; TRISAbits.TRISA3 = 1;

    #define sk5                 PORTAbits.RA2
    #define sk6                 PORTAbits.RA3
